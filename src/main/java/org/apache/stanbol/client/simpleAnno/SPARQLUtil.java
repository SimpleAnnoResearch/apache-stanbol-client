...
public enum SPARQLUtil {
    ...
    public static ResultSet stanbolQuery(String query) {
        QueryExecution queryExecution = QueryExecutionFactory.sparqlService("http://ontology.simple-anno.de:9090/sparql", query);
    ...
    public static ResultSet parameterizedQuery(Query query) {
        QueryExecution queryExecution = QueryExecutionFactory.sparqlService("http://dbpedia.org/sparql", query);
